...
#:
#: Test-retest reliability is estimated only from subjects measured twice, so
#: subjects with fewer complete sessions contribute nothing to the ICC while
#: still inflating the headline "Participants: N". Filtering here — at the point
#: the BIDS tree is written — keeps the published dataset and every downstream
#: count (demographics, violins, ICC) describing the SAME sample.
REQUIRED_COMPLETE_SESSIONS = 2
