...
# -*- coding: utf-8 -*-
"""
OLMM – Short Version (PsychoPy) [English]
=================================
...
------------
  ...
  Phase 2  2.0 s  Feedback: "Correct!" / "Wrong!" / "Too late!" above the
...
def run_learning_trial(img_path, phase="learning", block=1, rep=1,
    ...
    Phase 2  (2.0 s):  "Correct!" / "Wrong!" / "Too late!" above the _k_ image.
    """
...
def run_control_trial(img_path, phase="control", block=1, rep=1, trial_idx=1):
    ...
    Phase 2  (2.0 s):  "Correct!" / "Wrong!" / "Too late!" above same image
